...
class RelojArenaFormulador
{
    ...
    {
        $consulta = $this->db->query('SELECT * FROM reloj_arena_formulador WHERE id = 1');
        $fila = $consulta->fetch();
    ...
    public function guardar(string $fechaInicio, string $fechaCierre): bool
    {
        $consulta = $this->db->prepare(
            'INSERT INTO reloj_arena_formulador (id, fecha_inicio, fecha_cierre)
    ...
    public function estaDentroDeVentana(): bool
    {
        ...
        return $hoy >= $configuracion['fecha_inicio'] && $hoy <= $configuracion['fecha_cierre'];
    }
}
