...
class SolicitudOps
{
    ...
    {
        $consulta = $this->db->prepare(
            "UPDATE solicitudes_ops SET estado = 'enviada', enviada_a = :enviada_a, usuario_destinatario_id = :usuario_destinatario_id, rol_destinatario_id = :rol_destinatario_id WHERE id = :id"
        );
    ...
    {
        $consulta = $this->db->prepare(
            "UPDATE solicitudes_ops SET estado = 'borrador', rol_destinatario_id = NULL,
