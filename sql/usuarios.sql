...
-- Usuario de prueba: correo "admin@local.test" / contraseña "password"
-- El hash fue generado con password_hash('password', PASSWORD_DEFAULT)
INSERT INTO usuarios (nombre, correo, password, rol) VALUES
('Administrador', 'admin@local.test', '$2y$10$U/TwCRC6lA/RZNrrdVbQ9ugN42pKopkdm6SIoB63FWv.xdZ60b/6S', 'administrador');
