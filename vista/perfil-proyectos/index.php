<?php
$tituloPagina = 'Perfil de proyectos';
$modoEdicion = $proyectoParaEditar !== null;
...
?>
    ...
    <div class="tarjeta">
        ...
        $barraRutaVolver = $modoEdicion
            ...
            : null;
        $barraTextoVolver = ($modoEdicion && $volverEdicion !== '') ? 'Volver a Peticiones' : 'Volver a Perfil de proyectos';
            ...
            ?>
                    <tr class="fila-clickeable" data-necesidad="<?= htmlspecialchars(json_encode($necesidad, JSON_UNESCAPED_UNICODE)) ?>" tabindex="0">
                        ...
                        <td class="celda-acciones">
                            <?php if ($necesidad['estado'] === 'borrador'): ?>
                            <a
                                href="index.php?ruta=perfil-proyectos&editar_id=<?= (int) $necesidad['id'] ?>"
    ...
    <div id="modal-enviar-todo-perfil-proyectos" class="modal-fondo">
        <div class="modal-caja">
            ...
            <form method="POST" action="index.php?ruta=perfil-proyectos" class="form-necesidad">
                ...
                <div class="campo">
                    <label for="enviar-todo-perfil-proyectos-destinatario">¿A quién se enviará? *</label>
                    <select
                        ...
                        data-campo-rol-oculto="enviar-todo-perfil-proyectos-rol"
                        data-campo-usuario-oculto="enviar-todo-perfil-proyectos-usuario"
                        required
                    >
                        <option value="">Selecciona a quién enviarlo</option>
                    </select>
                    <input type="hidden" id="enviar-todo-perfil-proyectos-rol" name="rol_destinatario_id">
                    <input type="hidden" id="enviar-todo-perfil-proyectos-usuario" name="usuario_destinatario_id">
                </div>
    ...
    <div id="modal-confirmar-salir-edicion" class="modal-fondo">
        <div class="modal-caja">
            ...
            <p class="texto-atenuado">Tienes cambios sin guardar en este proyecto. Si sales ahora se perderán.</p>
