<?php
/**
 * Estado "Edición" (Épica 2, 2.3) para Extensión — pestaña Egresos.
 ...
 * $categoriasEgreso, $sedes, $tieneHijas, $dependenciaPorDefecto,
...
<form
    method="POST"
    action="index.php?ruta=extension&tab=egresos&anio_id=<?= (int) $anioSeleccionadoId ?>&autogestion_id=<?= (int) $autogestionSeleccionadoId ?>&editar_id=<?= (int) $egresoParaEditar['id'] ?>"
