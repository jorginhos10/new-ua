...
?>
    ...
    <div class="tarjeta">
        ...
        $barraBuscar = $modoEdicion ? null : '[data-toggle-envio="extension"]';
        ...
        $filaEgresoExtension = static function (array $gasto) use ($anioSeleccionadoId, $autogestionSeleccionadoId, $nombresMeses, $permisosAutomaticosPorTipo): void {
        ...
        <div class="fila-chips-toggle solo-toggle">
            <button type="button" class="toggle-envio-boton es-borrador" data-toggle-envio-boton="extension" data-texto-borrador="<?= htmlspecialchars($textoToggleBorrador) ?>" data-texto-enviado="<?= htmlspecialchars($textoToggleEnviado) ?>"><?= htmlspecialchars($textoToggleBorrador) ?></button>
        </div>
        <div data-toggle-envio="extension" data-mostrando="borrador">
            ...
            <div class="panel-toggle-envio oculto" data-panel-envio="enviado">
                <div class="panel-lotes-enviados">
                    ...
                    <?php endif; ?>
                    <?php
                    $rutaAccionLote = 'index.php?ruta=extension&tab=egresos&anio_id=' . (int) $anioSeleccionadoId . '&autogestion_id=' . (int) $autogestionSeleccionadoId;
                    $origenLote = 'gasto_extension';
        ...
        <div data-toggle-envio="extension" data-mostrando="borrador">
            ...
            <div class="panel-toggle-envio oculto" data-panel-envio="enviado">
                <div class="panel-lotes-enviados">
                    ...
                    <?php endif; ?>
                    <?php
                    $rutaAccionLote = 'index.php?ruta=extension&tab=ingresos&anio_id=' . (int) $anioSeleccionadoId . '&autogestion_id=' . (int) $autogestionSeleccionadoId;
                    $origenLote = 'ingreso_extension';
                    foreach ($lotesEnviados as $loteVista) {
                        require __DIR__ . '/../parciales/tarjeta-lote.php';
                    }
                    ?>
    ...
    <div id="modal-enviar-todo-extension" class="modal-fondo">
        <div class="modal-caja">
            ...
            <form method="POST" action="index.php?ruta=extension&anio_id=<?= (int) $anioSeleccionadoId ?>&autogestion_id=<?= (int) $autogestionSeleccionadoId ?>" class="form-necesidad">
                ...
                <div class="campo">
                    <label for="enviar-todo-extension-destinatario">¿A quién se enviará? *</label>
                    <select
                        id="enviar-todo-extension-destinatario"
                        class="selector-rol-destinatario"
                        data-campo-dependencia="enviar-todo-extension-destino"
                        data-campo-rol-oculto="enviar-todo-extension-rol"
                        data-campo-usuario-oculto="enviar-todo-extension-usuario"
                        required
                    >
                        <option value="">Selecciona a quién enviarlo</option>
                    </select>
                    <input type="hidden" id="enviar-todo-extension-rol" name="rol_destinatario_id">
                    <input type="hidden" id="enviar-todo-extension-usuario" name="usuario_destinatario_id">
                </div>
