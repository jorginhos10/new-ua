<?php
/**
 * Estado "Edición" (Épica 2, 2.3) para Extensión — pestaña Ingresos.
 ...
 * $autogestionSeleccionadoId, $volverEdicion, $error, $aniosActivos,
 * $tieneHijas, $dependenciaPorDefecto, $dependenciasSugeridas.
 */
?>
...
<form
    method="POST"
    action="index.php?ruta=extension&tab=ingresos&anio_id=<?= (int) $anioSeleccionadoId ?>&autogestion_id=<?= (int) $autogestionSeleccionadoId ?>&editar_id=<?= (int) $ingresoParaEditar['id'] ?>"
