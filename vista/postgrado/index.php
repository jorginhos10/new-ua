...
?>
    ...
    <div class="tarjeta">
        ...
        <div class="acciones-importar-exportar">
            <a href="index.php?ruta=postgrado-exportar-plantilla" class="boton-secundario">Exportar plantilla (.xlsx)</a>
            <a href="index.php?ruta=postgrado-exportar<?= $anioSeleccionadoId > 0 ? '&anio_id=' . $anioSeleccionadoId : '' ?>" class="boton-secundario">Exportar ingresos y gastos (.xlsx)</a>
            <form method="POST" action="index.php?ruta=postgrado&tab=<?= htmlspecialchars($tab) ?>&anio_id=<?= (int) $anioSeleccionadoId ?>" enctype="multipart/form-data" class="form-importar">
            ...
            <div class="acordeon-cuerpo">
                <div class="tabla-scroll">
                    <table class="tabla-usuarios">
                        ...
                        <tbody>
                            <?php foreach ($egresosEnviado as $gasto): $filaEgresoPostgrado($gasto); endforeach; ?>
            ...
            <div class="acordeon-cuerpo">
                <div class="tabla-scroll">
                    <table class="tabla-usuarios">
                        ...
                        <tbody>
                            <?php foreach ($ingresosEnviado as $ingreso): $filaIngresoPostgrado($ingreso); endforeach; ?>
