    ...
    <div id="modal-enviar-todo-unisalud" class="modal-fondo">
        <div class="modal-caja">
            ...
            <form method="POST" action="index.php?ruta=unisalud&anio_id=<?= (int) $anioSeleccionadoId ?>" class="form-necesidad">
                ...
                <div class="campo">
                    <label for="enviar-todo-unisalud-rol">Rol al que se enviará *</label>
                    <select id="enviar-todo-unisalud-rol" name="rol_destinatario_id" required>
                ...
                <div class="campo" style="display:none;">
                    <label for="enviar-todo-unisalud-destinatario">¿A quién exactamente? *</label>
                    <select
                        ...
                        data-campo-rol="enviar-todo-unisalud-rol"
                    >
