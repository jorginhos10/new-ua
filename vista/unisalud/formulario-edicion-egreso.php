<?php
/**
 * Estado "Edición" (Épica 2, 2.3) para Unisalud — pestaña Egresos.
...
<form
    method="POST"
    action="index.php?ruta=unisalud&tab=egresos&anio_id=<?= (int) $anioSeleccionadoId ?>&editar_id=<?= (int) $egresoParaEditar['id'] ?>"
