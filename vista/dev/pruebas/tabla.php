...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function activarVistaGrafica() {
        ...
        // ya llama a actualizarGrafica()); acá solo forzamos que la fila quede visible y fija
        // mientras se está en este modo, en vez de depender del toggle "Filtrar" de la tabla.
