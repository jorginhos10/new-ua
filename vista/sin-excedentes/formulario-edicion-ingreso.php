<?php
/**
 * Estado "Edición" (Épica 2, 2.3) para Sin Excedentes — pestaña Ingresos.
...
<form
    method="POST"
    action="index.php?ruta=sin-excedentes&tab=ingresos&anio_id=<?= (int) $anioSeleccionadoId ?>&editar_id=<?= (int) $ingresoParaEditar['id'] ?>"
