<?php
/**
 * Estado "Edición" (Épica 2, 2.3) para Sin Excedentes — pestaña Egresos.
...
<form
    method="POST"
    action="index.php?ruta=sin-excedentes&tab=egresos&anio_id=<?= (int) $anioSeleccionadoId ?>&editar_id=<?= (int) $egresoParaEditar['id'] ?>"
