...
?>
    ...
    <div class="tarjeta">
        ...
        <div class="acciones-importar-exportar">
            <a href="index.php?ruta=sin-excedentes-exportar-plantilla" class="boton-secundario">Exportar plantilla (.xlsx)</a>
            <a href="index.php?ruta=sin-excedentes-exportar<?= $anioSeleccionadoId > 0 ? '&anio_id=' . $anioSeleccionadoId : '' ?>" class="boton-secundario">Exportar ingresos y gastos (.xlsx)</a>
            <form method="POST" action="index.php?ruta=sin-excedentes&tab=<?= htmlspecialchars($tab) ?>&anio_id=<?= (int) $anioSeleccionadoId ?>" enctype="multipart/form-data" class="form-importar">
