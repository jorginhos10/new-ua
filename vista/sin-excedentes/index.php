...
?>
    ...
    <div class="tarjeta">
        ...
        $barraGruposIconos = [
            ...
            'datos' => [
                [
                    'id' => 'boton-exportar-plantilla-sin-excedentes',
                    'icono' => 'plantilla',
                    'etiqueta' => 'Exportar plantilla (.xlsx)',
                    'tipo' => 'a',
                    'href' => 'index.php?ruta=sin-excedentes-exportar-plantilla',
                ],
                [
                    'id' => 'boton-importar-sin-excedentes',
                    'icono' => 'importar',
                ...
                [
                    'id' => 'boton-exportar-sin-excedentes',
                    'icono' => 'exportar',
                    'etiqueta' => 'Exportar ingresos y gastos (.xlsx)',
                    'tipo' => 'a',
                    'href' => 'index.php?ruta=sin-excedentes-exportar' . ($anioSeleccionadoId > 0 ? '&anio_id=' . $anioSeleccionadoId : ''),
                ],
            ],
        ];
        if ($modoEdicion) {
        ...
        $barraBuscar = $modoEdicion ? null : '[data-toggle-envio="sin-excedentes"]';
        ...
        <form method="POST" action="index.php?ruta=sin-excedentes&tab=<?= htmlspecialchars($tab) ?>&anio_id=<?= (int) $anioSeleccionadoId ?>" enctype="multipart/form-data" id="form-importar-sin-excedentes" style="display: none;">
            <input type="hidden" name="accion" value="importar">
            <input type="hidden" name="tab" value="<?= htmlspecialchars($tab) ?>">
            <input type="file" name="archivo" accept=".xlsx" id="input-importar-sin-excedentes">
        </form>
        ...
        $filaEgresoSinExcedentes = static function (array $gasto) use ($anioSeleccionadoId, $nombresMeses, $permisosAutomaticosPorTipo): void {
        ...
        <div class="fila-chips-toggle solo-toggle">
            <button type="button" class="toggle-envio-boton es-borrador" data-toggle-envio-boton="sin-excedentes" data-texto-borrador="<?= htmlspecialchars($textoToggleBorrador) ?>" data-texto-enviado="<?= htmlspecialchars($textoToggleEnviado) ?>"><?= htmlspecialchars($textoToggleBorrador) ?></button>
        </div>
        <div data-toggle-envio="sin-excedentes" data-mostrando="borrador">
            ...
            <div class="panel-toggle-envio oculto" data-panel-envio="enviado">
                <div class="panel-lotes-enviados">
                    ...
                    <?php endif; ?>
                    <?php
                    $rutaAccionLote = 'index.php?ruta=sin-excedentes&tab=egresos&anio_id=' . (int) $anioSeleccionadoId;
                    $origenLote = 'gasto_sin_excedentes';
        ...
        <div data-toggle-envio="sin-excedentes" data-mostrando="borrador">
            ...
            <div class="panel-toggle-envio oculto" data-panel-envio="enviado">
                <div class="panel-lotes-enviados">
                    ...
                    <?php endif; ?>
                    <?php
                    $rutaAccionLote = 'index.php?ruta=sin-excedentes&tab=ingresos&anio_id=' . (int) $anioSeleccionadoId;
                    $origenLote = 'ingreso_sin_excedentes';
                    foreach ($lotesEnviados as $loteVista) {
                        require __DIR__ . '/../parciales/tarjeta-lote.php';
                    }
                    ?>
