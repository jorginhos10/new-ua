...
$iconosPorRuta = [
    ...
    'consulta' => '<circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line>',
];
...
foreach (['configuraciones', 'usuarios', 'roles', 'lineas', 'motores', 'proyectos', 'rubros', 'anios-presupuestales', 'sedes', 'dependencias', 'facultades', 'jerarquias', 'variables-macroeconomicas', 'repositorios'] as $rutaConfig) {
